...
class SegmentRouteMapSanityCheckTest {

    private final TypeDescriptorShortString stringTd = new TypeDescriptorShortString();
    private final SegmentIdTypeDescriptor integerTd = new SegmentIdTypeDescriptor();
    ...
    private static PersistentSegmentRouteMap<String> createKeyToSegmentMap(
            final Directory directory,
            final TypeDescriptorShortString keyTypeDescriptor) {
        return new PersistentSegmentRouteMap<>(directory, keyTypeDescriptor);
    }
