...
class RuntimeSegmentLimitApplierTest {
    ...
    private RuntimeSegmentLimitApplier<Integer, String> applier;

    @BeforeEach
    void setUp() {
        applier = new RuntimeSegmentLimitApplier<>(segmentRegistry,
                segmentRuntime);
    }
    ...
    void applyUpdatesChunkStoreCacheLimit() {
        final RuntimeSegmentLimitApplier<Integer, String> cacheApplier =
