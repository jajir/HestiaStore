...
class MetricServiceBuilderTest {
    ...
    @Test
    void buildCreatesMetricServiceThatSnapshotsRuntime() {
        ...
        final MetricService service = completeBuilder().build();
        final SegmentIndexMetricsSnapshot snapshot = service.metricsSnapshot();

        assertNotNull(service);
        assertEquals(MetricServiceImpl.class, service.getClass());
    ...
    void buildRejectsMissingConfiguration() {
        final MetricServiceBuilder<Integer, String> builder =
    ...
    private MetricServiceBuilder<Integer, String> completeBuilder() {
        return MetricService.<Integer, String>builder()
                .withConf(conf)
