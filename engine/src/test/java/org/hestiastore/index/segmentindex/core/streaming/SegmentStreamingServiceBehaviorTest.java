...
class SegmentStreamingServiceBehaviorTest {
    ...
    private SegmentStreamingService<String, String> service;
    ...
    void setUp() {
        ...
        synchronizedKeyToSegmentMap = new KeyToSegmentMapSynchronizedAdapter<>(
                keyToSegmentMap);
        service = new SegmentStreamingService<>(
                synchronizedKeyToSegmentMap, segmentRegistry,
                stableSegmentGateway, new BusyRetryPolicy(1, 10));
    }
