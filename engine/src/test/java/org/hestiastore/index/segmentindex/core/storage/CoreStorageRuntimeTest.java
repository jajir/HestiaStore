...
class CoreStorageRuntimeTest {
    ...
    private CoreStorageRuntime<Integer, String> runtime;

    @BeforeEach
    void setUp() {
        runtime = new CoreStorageRuntime<>(runtimeTuningState, storageService,
    ...
    void constructorRejectsMissingCollaborators() {
        assertThrows(IllegalArgumentException.class,
                () -> new CoreStorageRuntime<>(null, storageService,
                        segmentRegistry, keyToSegmentMap));
        assertThrows(IllegalArgumentException.class,
                () -> new CoreStorageRuntime<>(runtimeTuningState, null,
                        segmentRegistry, keyToSegmentMap));
        assertThrows(IllegalArgumentException.class,
                () -> new CoreStorageRuntime<>(runtimeTuningState,
