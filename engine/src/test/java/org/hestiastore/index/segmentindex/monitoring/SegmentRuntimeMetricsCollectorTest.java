...
class SegmentRuntimeMetricsCollectorTest {
    ...
    private SegmentRuntimeMetricsCollector<Integer, String> collector;

    @BeforeEach
    void setUp() {
        collector = new SegmentRuntimeMetricsCollector<>(keyToSegmentMap,
                segmentRegistry);
    }
    ...
    void collectAggregatesOnlyMappedLoadedSegments() {
        ...
        final SegmentRuntimeMetrics metrics = collector.collect();
