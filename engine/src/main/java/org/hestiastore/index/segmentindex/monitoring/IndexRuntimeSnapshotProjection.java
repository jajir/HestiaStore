...
final class IndexRuntimeSnapshotProjection<K, V> {
    ...
    SegmentIndexRuntimeSnapshot project(
            final RuntimeMonitoringData collected) {
        final RuntimeMonitoringData metrics = Vldtn.requireNonNull(
                collected, "collected");
    ...
    private SegmentIndexOperationMetrics operations(
            final RuntimeMonitoringData metrics) {
    ...
    private SegmentIndexSegmentMetrics segments(
            final RuntimeMonitoringData metrics) {
        final SegmentRuntimeMetrics stable =
