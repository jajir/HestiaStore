...
public final class IndexConfigurationResolution<K, V> {
    ...
    public static <K, V> IndexConfigurationResolution<K, V> of(
            final EffectiveIndexConfiguration<K, V> configuration,
            final boolean writeRequired) {
        return new IndexConfigurationResolution<>(configuration,
                writeRequired);
    }
