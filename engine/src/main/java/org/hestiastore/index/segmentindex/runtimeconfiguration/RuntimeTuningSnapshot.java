...
public final class RuntimeTuningSnapshot {
    ...
    private RuntimeTuningSnapshot(final ConfigurationSnapshot snapshot) {
        ...
        this.writePath = new RuntimeWritePathTuningSnapshot(
                value(RuntimeSettingKey.MAX_NUMBER_OF_KEYS_IN_ACTIVE_PARTITION),
                value(RuntimeSettingKey.MAX_NUMBER_OF_KEYS_IN_PARTITION_BUFFER),
                value(RuntimeSettingKey.MAX_NUMBER_OF_KEYS_IN_INDEX_BUFFER),
                value(RuntimeSettingKey.MAX_NUMBER_OF_KEYS_IN_PARTITION_BEFORE_SPLIT));
    }
    ...
    public Integer getLegacyImmutableRunLimit() {
