 ...
 * Runtime code should use the resolved effective configuration after defaults
...
public class IndexConfiguration<K, V> {
    ...
    private final boolean walConfigured;
    ...
    IndexConfiguration(final IndexIdentityConfiguration<K, V> identity,
            ...
            final IndexWalConfiguration wal, final boolean walConfigured,
        ...
        this.walConfigured = walConfigured;
     ...
     *
     * @return WAL settings, or {@link IndexWalConfiguration#EMPTY} when not
     *         provided
     */
    ...
    /**
     * Returns whether the request explicitly configured the WAL section.
     *
     * @return true when WAL was configured by the caller
     */
    public boolean isWalConfigured() {
        return walConfigured;
    }
