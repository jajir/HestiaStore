 ...
 *
 */
public final class IndexConfigurationDefaultsRegistry {
    /**
    ...
    private static final Map<Key, IndexConfigurationDefaults> confs = new HashMap<>();

    static {
        addTypeDefaultConf(Integer.class,
                new IntegerIndexConfigurationDefaults());
        addTypeDefaultConf(Long.class, new IntegerIndexConfigurationDefaults());
        addTypeDefaultConf(String.class, new StringIndexConfigurationDefaults());
    }
     ...
     */
    public static <T> void addTypeDefaultConf(final Class<T> clazz,
            final IndexConfigurationDefaults typeConfiguration) {
     ...
     */
    public static <T> void add(final Class<T> clazz, final String memory,
            final IndexConfigurationDefaults typeConfiguration) {
     ...
     */
    public static <T> Optional<IndexConfigurationDefaults> get(
            final Class<T> clazz) {
    ...
    private IndexConfigurationDefaultsRegistry() {
