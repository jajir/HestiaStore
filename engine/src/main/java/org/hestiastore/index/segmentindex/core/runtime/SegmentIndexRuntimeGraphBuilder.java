...
final class SegmentIndexRuntimeGraphBuilder<K, V> {
    ...
    private SegmentIndexRuntime<K, V> createRuntime(
        ...
        return new SegmentIndexRuntime<>(SegmentIndexRuntimeState.create(
                request.keyTypeDescriptor, coreStorage, splitState,
                walRuntime, serviceState));
    }
