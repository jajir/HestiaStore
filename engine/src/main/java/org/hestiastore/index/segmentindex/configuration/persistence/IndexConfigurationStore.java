 ...
 * @param <V> value type
 */
public class IndexConfigurationStore<K, V> {
    ...
    public IndexConfigurationStore(final Directory directoryFacade) {
    ...
    public EffectiveIndexConfiguration<K, V> load() {
        ...
        final int segmentSplitKeyThreshold = getOrDefault(propsView,
                ...
                IndexConfigurationDefaults.DEFAULT_SEGMENT_SPLIT_KEY_THRESHOLD);
    ...
    private IndexWalConfiguration loadWal(final PropertyView propsView) {
        ...
        return IndexWalConfiguration.builder()
                .durability(resolveEnum(propsView, PROP_WAL_DURABILITY_MODE,
