...
class FilteredIndexIT {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(FilteredIndexIT.class);
    ...
    void test_index_with_snappy_and_xor_filters() {
        ...
        try (Index<String, String> index = Index.create(directory,
                createConf)) {
        ...
        try (Index<String, String> index = Index.open(directory, openConf)) {
