...
/**
 * A transaction for writing a sorted data file. The data is first written to a
 * temporary file, which is then renamed to the target file name upon commit.
 */
public class SortedDataFileFullWriterTx<K, V> implements Commitable {
     ...
     */
    public SortedDataFileFullWriterTx(final String fileName,
